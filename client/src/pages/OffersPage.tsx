      ...
      <div className="max-w-7xl mx-auto space-y-8">
                ...
                <Card key={offer.id} className="p-6 space-y-4 border-gray-200 shadow-xs">
                  ...
                  {offer.negotiations && offer.negotiations.length > 0 && (
                    <div className="space-y-2">
                      <span className="text-[11px] font-bold uppercase text-gray-500 block">Negotiation Timeline:</span>
                  ...
                  {offer.status === 'ACCEPTED' && (
                    <div className="pt-2">
                      <Button
                        variant="primary"
                        size="sm"
                        className="w-full bg-agri-600 text-xs"
        ...
        {confirmModal.isOpen && confirmModal.offer && (
          <Modal
            ...
            title={confirmModal.actionType === 'ACCEPTED' ? 'Accept Offer?' : 'Reject Offer?'}
          >
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Are you sure you want to {confirmModal.actionType === 'ACCEPTED' ? 'accept' : 'reject'} the offer of{' '}
                <strong>₹{confirmModal.offer.pricePerUnit}/kg</strong> for <strong>{confirmModal.offer.quantity} kg</strong> (Total ₹{confirmModal.offer.totalAmount.toLocaleString('en-IN')})?
              </p>
              ...
              <div className="flex gap-3 justify-end pt-2">
                ...
                <Button
                  ...
                  className={confirmModal.actionType === 'ACCEPTED' ? 'bg-agri-600' : ''}
                  onClick={handleConfirmAction}
                >
                  Confirm {confirmModal.actionType === 'ACCEPTED' ? 'Acceptance' : 'Rejection'}
                </Button>
              </div>
            </div>
          </Modal>
